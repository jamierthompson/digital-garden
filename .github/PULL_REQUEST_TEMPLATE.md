...
<!-- What changed, and why. Write it for the future agent reading `git log` and finding only this
     squash commit. One PR = one purpose. A short ordered "what landed" list earns its place. -->
