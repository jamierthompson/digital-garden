...
| **`@/*` alias**           | For app code, import as `@/lib/scheme`, never `../../../lib`. (Cross-package code uses its package name, e.g. `@garden/oklch`.)                                                                                                                                                                                                                                                                                                                                     | Configured in `tsconfig.json` `paths`. Survives file moves; ESLint boundaries match on `src/**`.                                                                                |
...
const load = () => import("@/entries/oklch-engine");
...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| Pure logic / utilities (no React, no I/O)           | `src/lib/*` (`scheme`, `keys`, resolvers); the `@garden/oklch` + `@garden/type` engines in `packages/*` | always — logic stays out of components                                                                                             |
