...
**Why:** [`runs/debug-baseline.md`](./runs/debug-baseline.md) correctly used read-only **subagents for
diagnosis** and reserved a **team for a multi-file fix**; [`runs/debug-with-skill.md`](./runs/debug-with-skill.md)
...
**Why:** [`runs/review-baseline.md`](./runs/review-baseline.md) named **`pr-review-toolkit:review-pr`**
...
- [`eval-design.md`](./eval-design.md) · [`findings.md`](./findings.md) · [`runs/`](./runs/) — the evidence
