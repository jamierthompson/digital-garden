...
| [`decision-records.md`](./decision-records.md)                           | When to open an ADR, how much debate it earns, the entry format, and the edit-in-place / git-as-audit-trail rule.                                                                             |
...
adversarial debate → synthesis**. Worked examples of that pattern live under
[`../sessions/`](../sessions/).
