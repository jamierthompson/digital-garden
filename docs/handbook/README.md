...
| [`working-with-agents.md`](./working-with-agents.md)                     | Cite-don't-remember, anchoring to decisions, the `AGENTS.md` entry point, multi-agent orchestration, subagent briefs, clean handoffs.                                   |
