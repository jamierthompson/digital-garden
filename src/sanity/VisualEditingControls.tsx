 ...
 *   layer: the entry's `theme` object / `componentKey` / etc. are stega-excluded in
 *   `stega.ts`, so the overlay only targets prose/caption fields, never the code-consumed ones.
