...
/**
 * The rules the Studio holds, as concrete values (no optionals — the UI is never in an
 ...
 * mounted Studio reproduces the un-ruled engine output bit-for-bit (#101). "Usable in zero
 * clicks" is the product promise; these values are that promise.
 */
export const DEFAULT_RULES: StudioRules = {
