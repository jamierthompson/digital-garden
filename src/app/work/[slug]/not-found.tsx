...
// The not-found boundary for `/work/<slug>` [D10, D19]. Rendered when the route calls
...
// contained by the defensive engine + `unstable_catchError` backstop, NOT by this file [D9].)
