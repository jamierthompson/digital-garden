// Starter seeds for the Studio's preset chips — a hue-spanning set so a first-time visitor
...
/** The preset roster. The first entry doubles as the Studio's default seed. */
...
/** The seed the Studio opens on — the ambient entry brand, so it starts on "its own" palette. */
