// The `first-light` project-local embed manifest.
//
...
// GENUINE second use). It is a typed declaration of which embed keys THIS
...
// typo is a compile error here, not a silent missing-embed placeholder at render time.
